...
const adicionarArtistaForm = async (req, res) => {
    try {
        ...
        res.render('adicionarArtist', { discos, generos });
    } catch (error) {
...
module.exports = { listArtistas, adicionarArtista, adicionarArtistaForm, deleteArtista, editArtistaForm, editArtista };
